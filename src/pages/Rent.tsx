...
const Rent = () => {
  ...
  const handleDaysChange = async (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    setRentFrequency(selectedFrequency);
  ...
  return (
    <Fragment>
      <section>
        <div className="p-4 bg-[url(./assets/AboutBg.svg)] flex justify-center items-end bg-no-repeat relative bg-cover bg-center min-h-[60vh]">
